...
(() => {
  ...
  const stylesheet =
    ...
    '.ctl button:hover{background:#d9772e}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '<div class="ctl" part="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="Replace image">Replace</button></div>' +
